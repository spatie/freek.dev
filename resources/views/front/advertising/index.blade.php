...
@section('content')
    <div class="markup">
        ...
        <h2>The blog</h2>
        <p>
            In 2018 the blog had 728 243 page views. If you want to view some more statistics and learn which pages were the most popular read <a href="https://freek.dev/four-years-of-murzebe">this blog post</a>.
        </p>
        <p>
        ...
        <p>
            An ad can be placed on all pages of the blog or one or more specific posts. It will be placed in a white box with a smaller font right above the post title. The ad will be displayed for at least a month.
        </p>
