...
@section('content')
    ...
    <div class="markup">
        ...
        <p>It is Freek.dev's policy to respect your privacy regarding any information we may collect while operating our
            ...
            "us",
            "we", or "https://freek.dev"). We respect your privacy and are committed to protecting personally
            identifiable
            ...
            information
            we collect through the Website and does not apply to our collection of information from other sources.</p>
        ...
        <p>Like most website operators, Freek.dev collects non-personally-identifying information of the sort that web
            browsers and servers typically make available, such as the browser type, language preference, referring
            site,
            and the date and time of each visitor request. Freek.dev's purpose in collecting non-personally identifying
            information is to better understand how Freek.dev's visitors use its website. From time to time, Freek.dev
            may
            release non-personally-identifying information in the aggregate, e.g., by publishing a report on trends in
            the
            usage of its website.</p>
        <p>Freek.dev also collects potentially personally-identifying information like Internet Protocol (IP) addresses
            for
            logged in users and for users leaving comments on https://freek.dev blog posts. Freek.dev only discloses
            logged
            in user and commenter IP addresses under the same circumstances that it uses and discloses
            personally-identifying information as described below.</p>

        <h2>Gathering of Personally-Identifying Information</h2>
        <p>Certain visitors to Freek.dev's websites choose to interact with Freek.dev in ways that require Freek.dev to
            gather personally-identifying information. The amount and type of information that Freek.dev gathers depends
            on
            the nature of the interaction. For example, we ask visitors who sign up for a newsletter at
            https://freek.dev to
            provide an email address.</p>
        ...
        <p>Ads appearing on our website may be delivered to users by advertising partners, who may set cookies. These
            ...
            Privacy
            Policy covers the use of cookies by Freek.dev and does not cover the use of cookies by any advertisers.</p>
        ...
        <p>Freek.dev may collect statistics about the behavior of visitors to its website. Freek.dev may display this
            information publicly or provide it to others. However, Freek.dev does not disclose your
            personally-identifying
            information.</p>

        <h2>Cookies</h2>
        <p>To enrich and perfect your online experience, Freek.dev uses "Cookies", similar technologies and services
        ...
        <p>A cookie is a string of information that a website stores on a visitor's computer, and that the visitor's
            browser
            provides to the website each time the visitor returns. Freek.dev uses cookies to help Freek.dev identify and
            track visitors, their usage of https://freek.dev, and their website access preferences. Freek.dev visitors
            who
            do not wish to have cookies placed on their computers should set their browsers to refuse cookies before
            using
            Freek.dev's websites, with the drawback that certain features of Freek.dev's websites may not function
            properly
        ...
        <p>By continuing to navigate our website without changing your cookie settings, you hereby acknowledge and agree
            to
            Freek.dev's use of cookies.</p>

        <h2>Privacy Policy Changes</h2>
        <p>Although most changes are likely to be minor, Freek.dev may change its Privacy Policy from time to time, and
            in
            Freek.dev's sole discretion. Freek.dev encourages visitors to frequently check this page for any changes to
            its
...
<br />
        ...
        <p>These terms and conditions outline the rules and regulations for the use of freek.dev's Website, located at
            https://freek.dev.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use freek.dev
            if
        ...
        <p>We employ the use of cookies. By accessing freek.dev, you agreed to use cookies in agreement with the
            freek.dev's
            Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, freek.dev and/or its licensors own the intellectual property rights for all material
            on
            freek.dev. All intellectual property rights are reserved. You may access this from freek.dev for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from freek.dev</li>
            <li>Sell, rent or sub-license material from freek.dev</li>
            <li>Reproduce, duplicate or copy material from freek.dev</li>
            <li>Redistribute content from freek.dev</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. freek.dev does not filter, edit, publish or review Comments prior to their presence on
            the
            website. Comments do not reflect the views and opinions of freek.dev,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, freek.dev shall not be liable for the Comments or for any liability, damages or expenses
            caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.</p>

        <p>freek.dev reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant freek.dev a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            freek.dev; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to freek.dev. Please include your name, your organization name, contact
        ...
        <p>No use of freek.dev's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
