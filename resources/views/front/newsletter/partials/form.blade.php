<form
    ...
    class="flex items-stretch {{ $class ?? '' }}"
>
    ...
    <input type="submit" name="submit" id="submit" value="Subscribe" class="px-3 text-sm text-white bg-orange-500 font-semibold border-y-2 border-orange-700 border-t-transparent">
</form>
