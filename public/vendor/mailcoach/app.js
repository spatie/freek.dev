...
__webpack_require__(/*! ./components/segmentField */ "./resources/js/components/segmentField.js");
...
function toggleConditionals(controller) {
  var value = getValue(controller);
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])("[data-conditional-".concat(controller.dataset.conditional, "]")).forEach(function (element) {
    element.classList.toggle('hidden', !element.matches("[data-conditional-".concat(controller.dataset.conditional, "=\"").concat(value, "\"]")));
  });
}
...
function getValue(controller) {
  ...
  if (controller.matches('[type="radio"]')) {
    var checkedInput = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])("[name=\"".concat(controller.name, "\"]")).find(function (radio) {
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('change', '[data-conditional]', function (_ref) {
  var target = _ref.target;
  toggleConditionals(target);
});
window.addEventListener('turbolinks:load', function () {
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["uniqBy"])(Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])('[data-conditional]'), function (node) {
    return node.name;
  }).forEach(toggleConditionals);
});
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('submit', '[data-confirm]', function (_ref) {
...
function initDatepickers() {
  document.querySelectorAll('[data-datepicker]').forEach(function (node) {
    var enableTime = node.dataset.withTime;
...
Object(_util__WEBPACK_IMPORTED_MODULE_1__["listen"])('input', '[data-dirty-check]', function (_ref) {
  var target = _ref.target;
  target.dirty = true;
});
Object(_util__WEBPACK_IMPORTED_MODULE_1__["listen"])('click', '[data-dirty-warn]', function () {
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-dismiss]', function (_ref) {
  var target = _ref.target;
  target.remove();
});
document.addEventListener('turbolinks:load', function () {
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["$$"])('[data-dismiss]').forEach(function (node) {
    var timeoutMs = Math.min(Math.max(node.textContent.trim().length * 50, 3000), 7000);
    setTimeout(function () {
      Object(_util__WEBPACK_IMPORTED_MODULE_0__["leave"])(node, 'fade').then(function () {
        node.remove();
      });
    }, timeoutMs);
  });
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-dropdown-trigger]', function (_ref) {
  var target = _ref.target;
  var dropdownList = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-dropdown-list]', target.closest('[data-dropdown]'));
...
function updateHtmlPreview() {
  var source = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-html-preview-source]');
  var target = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-html-preview-target]');

  if (!source || !target) {
    return;
  }

  target.src = "data:text/html;base64,".concat(btoa(source.value));
}
...
function showModal(name) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      onConfirm = _ref$onConfirm === void 0 ? _util__WEBPACK_IMPORTED_MODULE_0__["noop"] : _ref$onConfirm,
      _ref$onDismiss = _ref.onDismiss,
      onDismiss = _ref$onDismiss === void 0 ? _util__WEBPACK_IMPORTED_MODULE_0__["noop"] : _ref$onDismiss;

  var modal = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])("[data-modal=\"".concat(name, "\"]"));
  Object(_util__WEBPACK_IMPORTED_MODULE_0__["enter"])(modal, 'fade');
  var releaseFocus = Object(_util__WEBPACK_IMPORTED_MODULE_0__["trapFocus"])(modal);
...
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-trigger]', function (_ref2) {
  var target = _ref2.target;
  showModal(target.dataset.modalTrigger);
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-confirm]', function (_ref3) {
  var target = _ref3.target;
  var modal = target.closest('[data-modal]');
  modal.dispatchEvent(new Event('confirm'));
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-dismiss]', function (_ref4) {
  var target = _ref4.target;
  var modal = target.closest('[data-modal]');
  modal.dispatchEvent(new Event('dismiss'));
});
Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('click', '[data-modal-backdrop]', function (_ref5) {
...
document.addEventListener('turbolinks:load', function () {
  ...
  interval = setInterval(function () {
    var needsPolling = Object(_util__WEBPACK_IMPORTED_MODULE_1__["$$"])('[data-poll]');

    if (needsPolling.length) {
      needsPolling.forEach(function (node) {
        if (!node.id) {
...
function poll(nodes) {
  fetch('').then(function (response) {
    ...
    nodes.forEach(function (node) {
      var newNode = newDocument.getElementById(node.id);
...
/***/ "./resources/js/components/segmentField.js":
/*!*************************************************!*\
  !*** ./resources/js/components/segmentField.js ***!
  \*************************************************/
/*! no exports provided */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util */ "./resources/js/util/index.js");
/* harmony import */ var _tags__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tags */ "./resources/js/components/tags.js");


var tagsInput;

function setUpSegmentFields() {
  if (tagsInput) {
    tagsInput.destroy();
  }

  var selectNode = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segment-field-email-list]');

  if (!selectNode) {
    return;
  }

  var selectedOptionNode = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])("[value=\"".concat(selectNode.value, "\"]"), selectNode);
  var tagsNode = Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('[data-segment-field-tags]');
  var tags = JSON.parse(selectedOptionNode.dataset.segmentFieldEmailListTags);

  if (tags.length) {
    Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('input[type="radio"][value="matching_tags"]').disabled = false;
    tagsInput = Object(_tags__WEBPACK_IMPORTED_MODULE_1__["createTagsInput"])(tagsNode, {
      tags: JSON.parse(selectedOptionNode.dataset.segmentFieldEmailListTags),
      selectedTags: JSON.parse(tagsNode.dataset.segmentFieldTagsSelected),
      canCreateNewTags: false
    });
  } else {
    Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('input[type="radio"][value="matching_tags"]').disabled = true; // By using `click()` here, the linked conditiols will be toggled.

    Object(_util__WEBPACK_IMPORTED_MODULE_0__["$"])('input[type="radio"][value="entire_list"]').click();
  }
}

Object(_util__WEBPACK_IMPORTED_MODULE_0__["listen"])('input', '[data-segment-field-email-list]', setUpSegmentFields);
document.addEventListener('turbolinks:load', setUpSegmentFields);
...
function createTagsInput(node, _ref) {
  ...
  var tagsInput = new choices_js__WEBPACK_IMPORTED_MODULE_0___default.a(node, {
    removeItemButton: true,
    noResultsText: canCreateNewTags ? 'Type to add tags' : 'No tags found',
    noChoicesText: canCreateNewTags ? 'Type to add tags' : 'No tags to choose from',
    itemSelectText: canCreateNewTags ? 'Press to add' : ' Press to select',
    shouldSortItems: false,
  ...
  if (canCreateNewTags) {
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["$"])('input.choices__input', node.parentNode).addEventListener('input', function (event) {
...
document.addEventListener('turbolinks:load', function () {
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["$$"])('[data-tags]').forEach(function (node) {
...
var scrollPosition;
var preserveSearchFocusOn;
Object(_util__WEBPACK_IMPORTED_MODULE_1__["listen"])('click', '[data-turbolinks-preserve-scroll]', function () {
  scrollPosition = window.scrollY;
});
Object(_util__WEBPACK_IMPORTED_MODULE_1__["listen"])('input', '[data-turbolinks-search]', Object(_util__WEBPACK_IMPORTED_MODULE_1__["debounce"])(function (_ref) {
  var target = _ref.target;
  var url = target.value ? target.dataset.turbolinksSearchUrl.replace('%search%', target.value) : target.dataset.turbolinksSearchClearUrl;
  scrollPosition = window.scrollY;
...
document.addEventListener('turbolinks:render', function () {
  if (preserveSearchFocusOn === window.location.href) {
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["$"])('[data-turbolinks-search]').focus();
  }
...
function trapFocus(element) {
  var focusableElements = Object(_query__WEBPACK_IMPORTED_MODULE_0__["$$"])(focusableSelectors.join(', '), element);
...
/*!************************************!*\
  !*** ./resources/js/util/index.js ***!
  \************************************/
/*! exports provided: debounce, trapFocus, listen, noop, $, $$, enter, leave, uniqBy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _uniq__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./uniq */ "./resources/js/util/uniq.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "uniqBy", function() { return _uniq__WEBPACK_IMPORTED_MODULE_6__["uniqBy"]; });
...
function enter(element) {
  var transitionName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'transition';
  return new Promise(function (resolve) {
    element.classList.remove('hidden');
    element.classList.add("".concat(transitionName, "-enter"));
    element.classList.add("".concat(transitionName, "-enter-active"));
    nextFrame(function () {
      element.classList.remove("".concat(transitionName, "-enter"));
      afterTransition(element, function () {
        element.classList.remove("".concat(transitionName, "-enter-active"));
        nextFrame(function () {
          resolve(element);
        });
      });
...
function leave(element) {
  var transitionName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'transition';
  return new Promise(function (resolve) {
    element.classList.add("".concat(transitionName, "-leave-active"));
    nextFrame(function () {
      element.classList.add("".concat(transitionName, "-leave"));
      afterTransition(element, function () {
        element.classList.remove("".concat(transitionName, "-leave-active"));
...
/***/ "./resources/js/util/uniq.js":
/*!***********************************!*\
  !*** ./resources/js/util/uniq.js ***!
  \***********************************/
/*! exports provided: uniqBy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! /Users/freek/dev/code/laravel-mailcoach/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/freek/dev/code/laravel-mailcoach/resources/css/app.css */"./resources/css/app.css");
