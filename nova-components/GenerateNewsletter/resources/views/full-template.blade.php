...
<div role="article" aria-roledescription="email" aria-label lang="en"
    ...
    <div style="padding: 32px 24px;">
        ...
        <table style="width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
                <td style="background-color: #f1f5f9; padding: 24px;" bgcolor="#f1f5f9">
                    ...
                    <ul align="left" class="o-ml-24" style="font-size: 16px; list-style-type: disc; margin: 0 0 0 20px; padding: 0;">
                        ...
                        <li style="margin: 0 0 4px; text-align: left;"><a href="https://testing-laravel.com?utm_source=freek_dev?utm_medium=newsletter&utm_campaing=newsletter_{{ $editionNumber }}" style="color: #252f3f;">Testing Laravel</a></li>
                        ...
                        <li style="margin: 0 0 4px; text-align: left;"><a href="https://event-sourcing-laravel.com?utm_source=freek_dev?utm_medium=newsletter&utm_campaing=newsletter_{{ $editionNumber }}" style="color: #252f3f;">Event Sourcing in Laravel</a></li>
            ...
            <tr>
                <td style="background-color: #cfd8e3; line-height: 4px;" bgcolor="#cfd8e3">‌</td>
            </tr>
            <tr>
                <td style="height: 32px;" height="32"></td>
            </tr>
